...
export interface ApiCoughNewsItemCoughNewsItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'cough-news'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCoughNewsLandingCoughNewsLanding
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cough-news-landing.cough-news-landing'
    > &
      Schema.Attribute.Private;
    paragraph: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInsightInsight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'insights'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiInsightsLandingInsightsLanding
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::insights-landing.insights-landing'
    > &
      Schema.Attribute.Private;
    paragraph: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiNewsItemNewsItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'news'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPublicationPublication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'publications'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPublicationsLandingPublicationsLanding
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::publications-landing.publications-landing'
    > &
      Schema.Attribute.Private;
    paragraph: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiScienceAndResearchResourceScienceAndResearchResource
  extends Struct.SingleTypeSchema {
...
export interface ApiWhitePaperWhitePaper extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.String & Schema.Attribute.DefaultTo<'white-papers'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiWhitePapersLandingWhitePapersLanding
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::white-papers-landing.white-papers-landing'
    > &
      Schema.Attribute.Private;
    paragraph: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
